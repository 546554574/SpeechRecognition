...
public class SpeechRecognizerActivity extends AppCompatActivity implements SpeechRecognizerCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RxPermissionsTool.with(this).addPermission(Manifest.permission.RECORD_AUDIO).initPermission();
    ...
    public void startRecognizer(View view) {
        ...
        speechRecognizer.setToken("5ec0740fa2164211bcc5255ebf7aa224");
        // 请使用阿里云语音服务管控台(https://nls-portal.console.aliyun.com/)生成您的appkey
        speechRecognizer.setAppkey("1mIVDWkz0ftgHCZx");
        ...
        this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (!fullResult.equals("")) {
                    ...
                    try {
                        jsonObject = new JSONObject(fullResult);
